...
String createJsonObject(String fingerprint, String uid, int time, int amt) {
...
Future<void> sendGameAPI(String id, Function(String) callback, int amt) async {
  // Get current time
  int getEpochTimeString() => (DateTime.now().millisecondsSinceEpoch ~/ 1000);

  var req = createJsonObject(
      await getFingerprint(), getUserInfo()!, getEpochTimeString(), amt);
